        ...
        $.fn.resultLoading = function (options) {
            ...
            if (settings.status == 'success') {
                ...
                if (settings.statusText == '') {
                    settings.statusText = 'Success';
                }
                if (settings.statusIcon == '') {
                    settings.statusIcon = '<i class="fas fa-check"></i>';
                }
            ...
            if (settings.status == 'warning') {
                ...
                if (settings.statusText == '') {
                    settings.statusText = 'Warning';
                }
                if (settings.statusIcon == '') {
                    settings.statusIcon = '<i class="fas fa-exclamation-circle"></i>';
                }
            ...
            if (settings.status == 'error') {
                ...
                if (settings.statusText == '') {
                    settings.statusText = 'Error';
                }
                if (settings.statusIcon == '') {
                    settings.statusIcon = '<i class="fas fa-times"></i>';
                }
